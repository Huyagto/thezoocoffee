        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 hidden rounded-2xl bg-primary p-6 text-primary-foreground shadow-xl md:block">
              ...
              <p className="text-sm opacity-90">Locations to serve you</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 max-w-xl text-lg leading-relaxed text-muted-foreground text-pretty">
              Find your nearest TheZooCoffee and experience our warm, 
              welcoming atmosphere. Each location offers the same exceptional 
              coffee and service you love.
            </p>
